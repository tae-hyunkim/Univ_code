...
class Calculator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.digitButton = [Button(str(x),self.buttonClicked) for x in range(len(self.digitButton))]
        ...
        # 0에 대한 규칙을 찾을 수 없어 0은 제외하고 작업 진행 
        for i in range(1,len(self.digitButton)):
            numLayout.addWidget(self.digitButton[i], 2-(i-1)//3, max(0,(i%3)))
